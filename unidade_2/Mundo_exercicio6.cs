...
namespace CG_N2
{
    ...
    private Privado_Circulo obj_Circulo;
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            camera.ymin = -300; 
            camera.ymax = 300;
            //DESCOMENTAR METODOS PARA TESTAR.

            // Exercicio1(new Ponto4D(0, 0), 100, Color.Yellow, 5);
        ...
        private void Exercicio1(Ponto4D pontoCentral, int raio, Color cor, int tamanho, int pontos = 72, PrimitiveType primitivo = PrimitiveType.Points)
        {
            Circulo circulo = new Circulo("C", null, pontoCentral, raio, pontos, primitivo);
            circulo.ObjetoCor.CorR = cor.R; 
            circulo.ObjetoCor.CorG = cor.G; 
            circulo.ObjetoCor.CorB = cor.B;
        ...
        private void DesenharSegReta(Ponto4D ponto1, Ponto4D ponto2, Color cor)
        {
            ...
            segReta1.ObjetoCor.CorR = cor.R; 
            segReta1.ObjetoCor.CorG = cor.G; 
            segReta1.ObjetoCor.CorB = cor.B;
        ...
        private void Exercicio3()
        {
            ...
            Exercicio1(ponto1, 100, Color.Black, 5);
            Exercicio1(ponto2, 100, Color.Black, 5);
            Exercicio1(ponto3, 100, Color.Black, 5);
        }
        ...
        private void Exercicio7()
        {
            ...
            Exercicio1(new Ponto4D(0, 0), 300, Color.Black, 2, 720, PrimitiveType.LineLoop);
            Exercicio1(Mundo.pontoCentral, 50, Color.Black, 2, primitivo: PrimitiveType.LineLoop);
        }
